...
class _MediaViewerState extends State<MediaViewer> {
  ...
  Future<void> _loadMedia() async {
    ...
    try {
      ...
      // Video mạng: ưu tiên streaming để có first frame nhanh.
      final isNetworkVideo = _detectedMediaType == MediaType.video &&
      ...
      if (isNetworkVideo) {
        ...
        // Warm cache in background, không block việc phát video.
        if (widget.enableCaching) {
          unawaited(
            _resourceManager.downloadFile(
              url: widget.mediaUrl,
