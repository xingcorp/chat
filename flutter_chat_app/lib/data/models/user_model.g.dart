...
UserModel _userModelDeserialize(
  ...
  final object = UserModel(
    ...
    isOnline: reader.readBoolOrNull(offsets[3]) ?? false,
    lastSeen: reader.readDateTime(offsets[4]),
    roles: reader.readStringList(offsets[5]) ?? const [],
    serverId: reader.readString(offsets[6]),
...
extension UserModelByIndex on IsarCollection<UserModel> {
  Future<UserModel?> getByServerId(String serverId) {
    return getByIndex(r'serverId', [serverId]);
  }

  UserModel? getByServerIdSync(String serverId) {
  ...
  Future<List<UserModel?>> getAllByServerId(List<String> serverIdValues) {
    final values = serverIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'serverId', values);
  }

  List<UserModel?> getAllByServerIdSync(List<String> serverIdValues) {
    final values = serverIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByServerId(UserModel object) {
    return putByIndex(r'serverId', object);
  }

  Id putByServerIdSync(UserModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'serverId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByServerId(List<UserModel> objects) {
    return putAllByIndex(r'serverId', objects);
  }

  List<Id> putAllByServerIdSync(List<UserModel> objects,
      {bool saveLinks = true}) {
...
extension UserModelQueryWhere
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> serverIdEqualTo(
      String serverId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> serverIdNotEqualTo(
      String serverId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension UserModelQueryFilter
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> rolesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> rolesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> rolesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserModelQueryWhereDistinct
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByAvatarUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByRoles() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByStatusMessage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQueryProperty
  ...
  QueryBuilder<UserModel, String?, QQueryOperations> avatarUrlProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, List<String>, QQueryOperations> rolesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'roles');
    });
  }

  QueryBuilder<UserModel, String, QQueryOperations> serverIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'serverId');
    });
  }

  QueryBuilder<UserModel, String?, QQueryOperations> statusMessageProperty() {
    return QueryBuilder.apply(this, (query) {
