...
class AppDimens {
  ...
  /// Chat message avatar horizontal gap to bubble
  static const double chatMessageAvatarGap = spaceXSmall;
  ...
  /// Get avatar size for message rows in chat by breakpoint.
  ///
  /// - Desktop: medium (40dp) for better readability on wide screens
  /// - Mobile/Tablet: small (32dp) to keep message density compact
  static double getChatMessageAvatarSize(double screenWidth) {
    return isDesktop(screenWidth) ? avatarMedium : avatarSmall;
  }

  /// Get reserved avatar slot width for message rows.
  ///
  /// This keeps bubble alignment stable between rows that show/hide avatar.
  static double getChatMessageAvatarSlotWidth(double screenWidth) {
    return getChatMessageAvatarSize(screenWidth) + chatMessageAvatarGap;
  }
}
