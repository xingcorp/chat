...
import '../../di/dependency_injection.dart' as _i914;
...
import '../../domain/services/i_offline_queue_service.dart' as _i738;
...
import '../config/environment_manager.dart' as _i842;
...
import '../services/chat_sync_service.dart' as _i223;
...
import '../services/enhanced_message_queue_service.dart' as _i217;
...
import '../services/firebase_service_manager.dart' as _i177;
...
import '../services/media_processing_service_factory.dart' as _i711;
...
import '../services/production_logger.dart' as _i285;
...
_i174.GetIt configureDependencies(
  ...
  gh.singleton<_i260.SystemResourceMonitor>(
      () => appModule.provideSystemResourceMonitor());
  ...
  gh.singleton<_i221.AppLogger>(() => _i221.AppLogger());
  gh.singleton<_i665.DatabaseService>(() => _i665.DatabaseService());
  gh.singletonAsync<_i586.MediaService>(() => _i586.MediaService.create());
  gh.singleton<_i285.ProductionLogger>(() => _i285.ProductionLogger());
  ...
  gh.lazySingleton<_i711.MediaProcessingServiceFactory>(
      () => _i711.MediaProcessingServiceFactory());
  ...
  gh.singleton<_i177.FirebaseServiceManager>(
      () => _i177.FirebaseServiceManager(gh<_i221.AppLogger>()));
  gh.lazySingleton<_i410.ConnectionInfo>(() => _i410.ConnectionInfo(
        gh<_i895.Connectivity>(),
        logger: gh<_i974.Logger>(),
      ));
  gh.singleton<_i382.EnterpriseIntegrationService>(
      () => _i382.EnterpriseIntegrationService(gh<_i711.DatabaseService>()));
  gh.singleton<_i240.EnterpriseAppService>(
      () => _i240.EnterpriseAppService(gh<_i711.DatabaseService>()));
  ...
  gh.lazySingleton<_i788.GraphQLClientWrapper>(
  ...
  gh.lazySingleton<_i404.UserRemoteDataSource>(
  ...
  gh.lazySingleton<_i888.IConnectivityService>(
      () => _i888.ConnectivityServiceImpl(gh<_i895.Connectivity>()));
  gh.singleton<_i803.MemoryOptimizer>(() => _i803.MemoryOptimizer(
      performanceMonitor: gh<_i794.PerformanceMonitor>()));
  gh.lazySingleton<_i832.ChatLocalDataSource>(
      () => _i832.ChatLocalDataSourceImpl(gh<_i711.DatabaseService>()));
  gh.factory<_i648.AnalyticsManager>(
  ...
  gh.lazySingleton<_i439.UserLocalDataSource>(
  ...
  gh.factory<_i473.PermissionsRepository>(() => _i760.PermissionsRepositoryImpl(
        gh<_i656.PermissionsDataSource>(),
        gh<_i460.SharedPreferences>(),
        gh<_i221.AppLogger>(),
      ));
  gh.lazySingleton<_i425.IChatRepository>(
      () => _i415.EnterpriseChatRepositoryImpl(
            gh<_i832.ChatLocalDataSource>(),
            gh<InvalidType>(),
          ));
  gh.singletonAsync<_i393.MediaCache>(() => _i393.MediaCache.create(
        gh<_i794.PerformanceMonitor>(),
        gh<_i686.IsolateManager>(),
      ));
  ...
  gh.lazySingletonAsync<_i394.IMediaRepository>(
      () async => _i872.MediaRepositoryImpl(
            mediaService: await gh.getAsync<_i586.MediaService>(),
            mediaCache: await gh.getAsync<_i393.MediaCache>(),
  ...
  gh.lazySingleton<_i287.IRealtimeConnectionService>(
  ...
  gh.lazySingletonAsync<_i567.AttachmentQueueService>(
      () async => _i567.AttachmentQueueService(
            ...
            gh<_i47.ConnectivityService>(),
            await gh.getAsync<_i527.LocalStorageService>(),
            await gh.getAsync<_i393.MediaCache>(),
          ));
  ...
  gh.factoryAsync<_i921.MediaBloc>(() async => _i921.MediaBloc(
      mediaRepository: await gh.getAsync<_i394.IMediaRepository>()));
  ...
  gh.singleton<_i301.RealtimeService>(() =>
      _i301.RealtimeService(socketManager: gh<_i301.EnhancedSocketManager>()));
  ...
  gh.lazySingleton<_i102.IMessageRemoteDataSource>(
  ...
  gh.lazySingleton<_i572.IMessageRepository>(() => _i564.MessageRepositoryImpl(
  ...
  gh.lazySingletonAsync<_i217.EnhancedMessageQueueService>(
      () async => _i217.EnhancedMessageQueueService(
            gh<_i572.IMessageRepository>(),
            await gh.getAsync<_i527.LocalStorageService>(),
            gh<_i47.ConnectivityService>(),
            gh<_i287.IRealtimeConnectionService>(),
            await gh.getAsync<_i567.AttachmentQueueService>(),
          ));
  ...
  gh.lazySingletonAsync<_i223.ChatSyncService>(
      () async => _i223.ChatSyncService(
            gh<_i425.IChatRepository>(),
            gh<_i572.IMessageRepository>(),
            await gh.getAsync<_i527.LocalStorageService>(),
            gh<_i47.ConnectivityService>(),
          ));
  gh.factoryAsync<_i379.MessageQueueBloc>(() async =>
      _i379.MessageQueueBloc(await gh.getAsync<_i556.MessageQueueService>()));
  gh.lazySingletonAsync<_i1060.ChatMessageService>(
      () async => _i1060.ChatMessageService(
            await gh.getAsync<_i556.MessageQueueService>(),
            gh<_i357.RealtimeConnectionService>(),
            gh<_i98.GraphQLSubscriptionService>(),
            gh<_i572.IMessageRepository>(),
          ));
  gh.singleton<_i738.IOfflineQueueService>(() => _i520.OfflineQueueService(
        isar: gh<_i338.Isar>(),
...
class _$AppModule extends _i914.AppModule {}
