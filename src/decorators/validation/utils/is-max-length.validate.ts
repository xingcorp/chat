...
@ValidatorConstraint()
export class IsMaxLengthValidateConstraint extends BaseValidateDecoratorConstraint {
...
export function IsMaxLengthValidate(property: number, validationOptions?: ValidationOptions) {
    return function (object: Object, propertyName: string) {
        baseRegisterDecorator({
            name: 'IsMaxLengthValidate',
            target: object.constructor,
            constraints: [property],
            propertyName: propertyName,
            options: validationOptions,
            validator: IsMaxLengthValidateConstraint,
        });
    };
}