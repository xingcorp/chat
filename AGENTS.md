...
### GraphQL (Code-First)
- Decorators: `@ObjectType`, `@InputType`, `@Resolver`, `@Query`, `@Mutation`
- Validation: class-validator (`@IsNotEmpty`, `@IsEmail`, `@MinLength`)
- Errors: throw `OfficeError(code, message, statusCode)`
